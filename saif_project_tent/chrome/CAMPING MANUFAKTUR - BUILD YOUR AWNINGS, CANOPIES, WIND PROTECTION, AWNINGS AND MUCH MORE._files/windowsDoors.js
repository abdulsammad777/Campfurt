...
//-----------------render window and door depends on layout -----------------------
var frontLayout = {
...
// var frontlayout =  $(".front-wall").find('.pl-card')
// var fdoorSection = $(".front-wall .front-door-section")
// var fbgwindowinactive = $(".front-wall .windows .panel-heading")
// var fwindowunbind = $(".front-wall .windows .panel-heading").find('a').first()
// var fbgdoorinactive = $(".front-wall .doors .panel-heading")
// var fdoorunbind = $(".front-wall .doors .panel-heading").find('a').first()
// var fonewindow =   $(".front-wall .front-one-window")
// var ftwowindow =   $(".front-wall .front-two-window")
// var fthreewindow =   $(".front-wall .front-three-window")
// var colapsFrontDoor = "#collapseThree-front-door"
// var colapsFrontWindow ="#collapseTwo-front-layout"